                                    ...
                                    <g id="areas">
                                        ...
                                        <g id="s">
                                            <path id="s19" fill="#F7E9CD"
                                                  class="{{$active_number === 's19' ? 'highlighted' : ''}}"
                                            ...
                                            <path id="s14" fill="#000000"
                                                  class="{{$active_number === 's14' ? 'highlighted' : ''}}"
                                            ...
                                            <path id="s4" fill="#F7E9CD"
                                                  class="{{$active_number === 's4' ? 'highlighted' : ''}}"
                                            ...
                                            <path id="s16" fill="#F7E9CD"
                                                  class="{{$active_number === 's16' ? 'highlighted' : ''}}"
                                            ...
                                            <path id="s9" fill="#F7E9CD"
                                                  class="{{$active_number === 's9' ? 'highlighted' : ''}}"
                                            ...
                                            <path id="s7" fill="#000000"
                                                  class="{{$active_number === 's7' ? 'highlighted' : ''}}"
                                            ...
                                            <path id="s8" fill="#000000"
                                                  class="{{$active_number === 's8' ? 'highlighted' : ''}}"
                                            ...
                                            <path id="s12" fill="#000000"
                                                  class="{{$active_number === 's12' ? 'highlighted' : ''}}"
                                            ...
                                            <path id="s1" fill="#F7E9CD"
                                                  class="{{$active_number === 's1' ? 'highlighted' : ''}}"
                                            ...
                                            <path id="s18" fill="#000000"
                                                  class="{{$active_number === 's18' ? 'highlighted' : ''}}"
                                            ...
                                            <path id="s20" fill="#000000"
                                                  class="{{$active_number === 's20' ? 'highlighted' : ''}}"
                                            ...
                                            <path id="s5" fill="#F7E9CD"
                                                  class="{{$active_number === 's5' ? 'highlighted' : ''}}"
                                            ...
                                            <path id="s3" fill="#000000"
                                                  class="{{$active_number === 's3' ? 'highlighted' : ''}}"
                                            ...
                                            <path id="s10" fill="#000000"
                                                  class="{{$active_number === 's10' ? 'highlighted' : ''}}"
                                            ...
                                            <path id="s17" fill="#F7E9CD"
                                                  class="{{$active_number === 's17' ? 'highlighted' : ''}}"
                                            ...
                                            <path id="s13" fill="#000000"
                                                  class="{{$active_number === 's13' ? 'highlighted' : ''}}"
                                            ...
                                            <path id="s2" fill="#000000"
                                                  class="{{$active_number === 's2' ? 'highlighted' : ''}}"
                                            ...
                                            <path id="s6" fill="#F7E9CD"
                                                  class="{{$active_number === 's6' ? 'highlighted' : ''}}"
                                            ...
                                            <path id="s11" fill="#F7E9CD"
                                                  class="{{$active_number === 's11' ? 'highlighted' : ''}}"
                                            ...
                                            <path id="s15" fill="#F7E9CD"
                                                  class="{{$active_number === 's15' ? 'highlighted' : ''}}"
                                        ...
                                        <g id="d">
                                            <path id="d2" fill="#ED3737"
                                                  class="{{$active_number === 'd2' ? 'highlighted' : ''}}"
                                            ...
                                            <path id="d17" fill="#4F9962"
                                                  class="{{$active_number === 'd17' ? 'highlighted' : ''}}"
                                            ...
                                            <path id="d15" fill="#4F9962"
                                                  class="{{$active_number === 'd15' ? 'highlighted' : ''}}"
                                            ...
                                            <path id="d6" fill="#4F9962"
                                                  class="{{$active_number === 'd6' ? 'highlighted' : ''}}"
                                            ...
                                            <path id="d14" fill="#ED3737"
                                                  class="{{$active_number === 'd14' ? 'highlighted' : ''}}"
                                            ...
                                            <path id="d10" fill="#ED3737"
                                                  class="{{$active_number === 'd10' ? 'highlighted' : ''}}"
                                            ...
                                            <path id="d11" fill="#4F9962"
                                                  class="{{$active_number === 'd11' ? 'highlighted' : ''}}"
                                            ...
                                            <path id="d19" fill="#4F9962"
                                                  class="{{$active_number === 'd19' ? 'highlighted' : ''}}"
                                            ...
                                            <path id="d8" fill="#ED3737"
                                                  class="{{$active_number === 'd8' ? 'highlighted' : ''}}"
                                            ...
                                            <path id="d16" fill="#4F9962"
                                                  class="{{$active_number === 'd16' ? 'highlighted' : ''}}"
                                            ...
                                            <path id="d7" fill="#ED3737"
                                                  class="{{$active_number === 'd7' ? 'highlighted' : ''}}"
                                            ...
                                            <path id="d3" fill="#ED3737"
                                                  class="{{$active_number === 'd3' ? 'highlighted' : ''}}"
                                            ...
                                            <path id="d1" fill="#4F9962"
                                                  class="{{$active_number === 'd1' ? 'highlighted' : ''}}"
                                            ...
                                            <path id="d20" fill="#ED3737"
                                                  class="{{$active_number === 'd20' ? 'highlighted' : ''}}"
                                            ...
                                            <path id="d18" fill="#ED3737"
                                                  class="{{$active_number === 'd18' ? 'highlighted' : ''}}"
                                            ...
                                            <path id="d5" fill="#4F9962"
                                                  class="{{$active_number === 'd5' ? 'highlighted' : ''}}"
                                            ...
                                            <path id="d12" fill="#ED3737"
                                                  class="{{$active_number === 'd12' ? 'highlighted' : ''}}"
                                            ...
                                            <path id="d9" fill="#4F9962"
                                                  class="{{$active_number === 'd9' ? 'highlighted' : ''}}"
                                            ...
                                            <path id="d4" fill="#4F9962"
                                                  class="{{$active_number === 'd4' ? 'highlighted' : ''}}"
                                            ...
                                            <path id="d13" fill="#ED3737"
                                                  class="{{$active_number === 'd13' ? 'highlighted' : ''}}"
                                        ...
                                        <g id="t">
                                            <path id="t10" fill="#ED3737"
                                                  class="{{$active_number === 't10' ? 'highlighted' : ''}}"
                                            ...
                                            <path id="t13" fill="#ED3737"
                                                  class="{{$active_number === 't13' ? 'highlighted' : ''}}"
                                            ...
                                            <path id="t3" fill="#ED3737"
                                                  class="{{$active_number === 't3' ? 'highlighted' : ''}}"
                                            ...
                                            <path id="t2" fill="#ED3737"
                                                  class="{{$active_number === 't2' ? 'highlighted' : ''}}"
                                            ...
                                            <path id="t8" fill="#ED3737"
                                                  class="{{$active_number === 't8' ? 'highlighted' : ''}}"
                                            ...
                                            <path id="t14" fill="#ED3737"
                                                  class="{{$active_number === 't14' ? 'highlighted' : ''}}"
                                            ...
                                            <path id="t7" fill="#ED3737"
                                                  class="{{$active_number === 't7' ? 'highlighted' : ''}}"
                                            ...
                                            <path id="t9" fill="#4F9962"
                                                  class="{{$active_number === 't9' ? 'highlighted' : ''}}"
                                            ...
                                            <path id="t4" fill="#4F9962"
                                                  class="{{$active_number === 't4' ? 'highlighted' : ''}}"
                                            ...
                                            <path id="t17" fill="#4F9962"
                                                  class="{{$active_number === 't17' ? 'highlighted' : ''}}"
                                            ...
                                            <path id="t15" fill="#4F9962"
                                                  class="{{$active_number === 't15' ? 'highlighted' : ''}}"
                                            ...
                                            <path id="t18" fill="#ED3737"
                                                  class="{{$active_number === 't18' ? 'highlighted' : ''}}"
                                            ...
                                            <path id="t20" fill="#ED3737"
                                                  class="{{$active_number === 't20' ? 'highlighted' : ''}}"
                                            ...
                                            <path id="t5" fill="#4F9962"
                                                  class="{{$active_number === 't5' ? 'highlighted' : ''}}"
                                            ...
                                            <path id="t1" fill="#4F9962"
                                                  class="{{$active_number === 't1' ? 'highlighted' : ''}}"
                                            ...
                                            <path id="t12" fill="#ED3737"
                                                  class="{{$active_number === 't12' ? 'highlighted' : ''}}"
                                            ...
                                            <path id="t6" fill="#4F9962"
                                                  class="{{$active_number === 't6' ? 'highlighted' : ''}}"
                                            ...
                                            <path id="t11" fill="#4F9962"
                                                  class="{{$active_number === 't11' ? 'highlighted' : ''}}"
                                            ...
                                            <path id="t19" fill="#4F9962"
                                                  class="{{$active_number === 't19' ? 'highlighted' : ''}}"
                                            ...
                                            <path id="t16" fill="#4F9962"
                                                  class="{{$active_number === 't16' ? 'highlighted' : ''}}"
                                        ...
                                        <g id="bull">
                                            <path id="Outer" fill="#4F9962"
                                                  class="{{$active_number === 'Outer' ? 'highlighted' : ''}}"
                                            ...
                                            <circle id="Bull" fill="#ED3737" cx="401.5" cy="389" r="13.7"
                                                    class="{{$active_number === 'Bull' ? 'highlighted' : ''}}"/>
                                        </g>
                                    </g>
                                    <g id="score">
                    ...
                    <div class="flex-1 flex flex-col items-center justify-center text-center">
                        <div class="text-4xl sm:text-2xl md:text-2xl lg:text-7xl xl:text-8xl text-black">
                            ...
                            @if($game->activeElement->given_number_type === \App\Livewire\TenOfTenSelectGame::GAME_TYPE_SINGLES)
                                SINGLE
                            @elseif($game->activeElement->given_number_type === \App\Livewire\TenOfTenSelectGame::GAME_TYPE_DOUBLES)
                                DOUBLE
                            @elseif($game->activeElement->given_number_type === \App\Livewire\TenOfTenSelectGame::GAME_TYPE_TRIPLES)
                                TRIPLE
                            @endif
                        </div>
