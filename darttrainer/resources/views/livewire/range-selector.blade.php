        ...
        <div
            ...
            <div class="bg-white p-8 rounded w-full max-w-md">
                <div class="mb-4">
                    ...
                    <input type="number" id="from" wire:model="from"
                    ...
                    <input type="range" id="rangeFrom" min="2" max="330" step="1" wire:model="from"
                           class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"/>
                </div>
                @error('from')
                <span class="text-red-500 text-xs-mt3-block">{{ $message }}</span>
                @enderror
                <div class="mb-4">
                    <label for="to" class="block text-sm font-medium text-gray-700">To</label>
                    <input type="number" id="to" wire:model="to"
                           class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"/>
                    <input type="range" id="rangeTo" min="3" max="350" step="1" wire:model="to"
                           class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"/>
                </div>
                @error('to')
                <span class="text-red-500 text-xs-mt3-block">{{ $message }}</span>
