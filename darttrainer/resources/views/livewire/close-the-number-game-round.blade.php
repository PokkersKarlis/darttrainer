        ...
        @else
            ...
            <main class="h-full flex flex-col">
                ...
                <div class="bg-gray-200 p-4 space-y-4">
                    @if($counter_active)
                        <div class="grid grid-cols-3 gap-4 md:grid-cols-6 md:gap-4">
                            <!-- Buttons with SVG icons, numbers, and updated styles -->
                            @for ($i = 1; $i <= 6; $i++)
                                <button wire:click="setValue({{ $i }})"
                                        class="flex items-center justify-center px-4 py-2 rounded-md text-black font-bold bg-white border border-green-800 hover:bg-green-50 focus:outline-none focus:ring-2 focus:ring-green-400">
