    ...
    <div class="bg-indigo-900 text-center py-4 lg:px-4 relative overflow-hidden">
        <div class="p-2 animate-slide text-indigo-100 leading-none lg:rounded-full flex lg:inline-flex items-center" role="alert">
            @if(!empty($closing_game))
                <div class="flex rounded-full bg-indigo-500 uppercase px-4 py-2 text-xs font-bold mr-6">Close the number most active players:</div>
            ...
            @if(!empty($ten_of_ten_game))
                <div class="flex rounded-full bg-indigo-500 uppercase px-4 py-2 text-xs font-bold mr-6">Ten of ten most active players:</div>
                <div class="flex whitespace-nowrap">
