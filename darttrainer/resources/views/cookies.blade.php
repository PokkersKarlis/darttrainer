                        ...
                        <div class="container">
                            <div class="row main-row">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <div class="about-details">
                                        <h3><b>@lang('cookies.cookies_1')</b></h3>
                                        <br>
                                        <p>@lang('cookies.cookies_2')}</p>
                            ...
                            <div class="row main-row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="about-details">
                                        <h3><b>@lang('cookies.cookies_3')</b></h3>
                                        <br>
                                        <p>@lang('cookies.cookies_4')</p>
                                    </div><!-- end about-details  -->
                                </div><!-- end col-md-8  -->
                            </div><!-- end row  -->
                            <br>
                            <div class="row main-row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="about-details">
                                        <h3><b>@lang('cookies.cookies_5')</b></h3>
                                        <br>
                                        <p>@lang('cookies.cookies_6')</p>
                                    </div><!-- end about-details  -->
                                </div><!-- end col-md-8  -->
                            </div><!-- end row  -->
                            <br>
                            <div class="row main-row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="about-details">
                                        <h3><b>@lang('cookies.cookies_7')</b></h3>
                                        <br>
                                        <p>@lang('cookies.cookies_8')</p>
                                    </div><!-- end about-details  -->
                                </div><!-- end col-md-8  -->
                            </div><!-- end row  -->
                            <br>
                            <div class="row main-row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="about-details">
                                        <h3><b>@lang('cookies.cookies_9')</b></h3>
                                    </div><!-- end about-details  -->
                                </div><!-- end col-md-8  -->
                            </div><!-- end row  -->
                        </div><!-- end container  -->
