...
export const IMPOSSIBLE_CHECKOUTS = new Set([159, 162, 163, 165, 166, 168, 169, 172, 173, 175, 176, 178, 179]);
...
export function requiresCheckoutDartCount(remainingBefore: number, trackCheckoutRate: boolean): boolean {
...
export function requiresDoubleDartCount(points: number, remainingBefore: number, wouldBust: boolean): boolean {
...
export function calculatorVisitNeedsModal(points: number, remainingBefore: number, wouldBust: boolean, trackCheckoutRate: boolean): boolean {
    return (
