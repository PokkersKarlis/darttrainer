    ...
    <div>
        ...
        <div class="pf-wrap">
            ...
            <button type="button" class="pf-eye" :aria-label="showPassword ? t('pwd.hide') : t('pwd.show')" @click="showPassword = !showPassword">
                ...
                >
                    <path
                        d="M17.94 17.94A10.94 10.94 0 0112 19c-7 0-11-7-11-7a21.6 21.6 0 015.06-6.06M9.9 4.24A10.4 10.4 0 0112 4c7 0 11 7 11 7a21.6 21.6 0 01-2.16 3.19M14.12 14.12a3 3 0 11-4.24-4.24"
                    />
                    <path d="M1 1l22 22" />
                </svg>
            </button>
