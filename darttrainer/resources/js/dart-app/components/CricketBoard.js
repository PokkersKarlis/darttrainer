...
export default {
  ...
  setup(props) {
    ...
    /** Lauka cipars — tāds pats Miss pogas stils (atvērts); miris = pelēks. */
    ...
    return {
      t,
      segments, segKey, segLabel, digitHits, hitTitle, cellClass, headerSegClass, headerSegTextClass,
      closedByAll, leaderId, gridStyle,
    };
  },
  ...
  template: `
    <div class="rounded-xl border border-[#162540] bg-[#0f1c30] w-full min-w-0 overflow-hidden">
      ...
      <!-- ═══ MOBILAIS: vertikāls — segmenti kā rindas, kolonnas = spēlētāji ═══ -->
      ...
      <!-- ═══ DESKTOP: horizontālais režģis (≥ md) ═══ -->
