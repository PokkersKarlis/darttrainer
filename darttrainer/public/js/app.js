...
app.component('ShellBrandLogo', ShellBrandLogo);
app.component('ShellFriendIncomingButton', ShellFriendIncomingButton);
app.component('ShellLocaleSwitch', ShellLocaleSwitch);
app.component('ShellAuthPendingIndicator', ShellAuthPendingIndicator);
app.component('ShellHeaderAdminLink', ShellHeaderAdminLink);
app.component('ShellUserSummary', ShellUserSummary);
app.component('ShellLogoutButton', ShellLogoutButton);
app.component('ShellHeaderGuestLinks', ShellHeaderGuestLinks);
app.component('AppShellHeader', AppShellHeader);
...
app.component('AppShellBody', AppShellBody);
