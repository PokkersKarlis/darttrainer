/**
 * Slēgta segmenta atzīme.
 * - prominent: scoreboard šūna (CricketMarkCell) — ievērojami lielāka par 0/1/2
 * - boosted: pārējās tabulas šūnas — nedaudz lielāka par ciparu
 */
const CricketClosedCheck = {
  props: {
