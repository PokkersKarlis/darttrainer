import{u as Z,a as Q,c as Y,w as S,q as tt,a2 as i,J as v,r as c}from"./main-B4nAQLc1.js";/* empty css            */import"./index-BuNY4Ty6.js";const at={setup(){const p=Z(),g=Q(),k=e=>g.t(e),M=Y(),P=c("users"),b=c(!1),A=c(null),B=c({items:[],meta:{}}),h=c(1),n=v({search:"",only_admin:!1,only_banned:!1,date_from:"",date_to:""}),C=c({items:[],meta:{}}),U=c(1),u=c(null),x=c(""),d=v({open:!1,kind:"",id:null,chk:!1}),s=v({open:!1,kind:"",user:null,banReason:"",revokeAck:!1}),y=c(!1);let w=null;const _=v({}),T=v({});function R(e){const t=String(e||"").trim();if(!t||t==="127.0.0.1"||t==="::1"||t==="localhost"||t.startsWith("10.")||t.startsWith("192.168.")||t.startsWith("169.254."))return!0;if(t.startsWith("172.")){const o=t.split("."),a=Number(o[1]);if(a>=16&&a<=31)return!0}return!1}function j(e){const t=String(e||"").trim().toUpperCase();if(!/^[A-Z]{2}$/.test(t))return"";const o=127462,a=t.charCodeAt(0)-65,l=t.charCodeAt(1)-65;return String.fromCodePoint(o+a,o+l)}async function z(e){const t=String(e||"").trim();if(!(!t||R(t))&&!(_[t]||T[t])){T[t]=!0;try{const o=await fetch(`https://ipapi.co/${encodeURIComponent(t)}/country/`,{cache:"force-cache"});if(!o.ok)return;const a=(await o.text()).trim().toUpperCase();/^[A-Z]{2}$/.test(a)&&(_[t]=a)}catch{}finally{T[t]=!1}}}function F(e,t){var a,l;const o=String(t??"");(a=navigator.clipboard)!=null&&a.writeText?navigator.clipboard.writeText(o).then(()=>{var r;(r=window._dartToast)==null||r.call(window,k("admin.copied")+": "+e,"success")}).catch(()=>{var r;return(r=window._dartToast)==null?void 0:r.call(window,"Copy failed","error")}):(l=window._dartToast)==null||l.call(window,"Clipboard nav pieejams","error")}async function m(){var e,t;try{const{data:o}=await i.overview();A.value=o;const a=((o==null?void 0:o.sessions)||[]).map(r=>r==null?void 0:r.ip_address).filter(Boolean);Array.from(new Set(a)).slice(0,50).forEach(r=>z(r))}catch(o){((e=o.response)==null?void 0:e.status)===403&&((t=window._dartToast)==null||t.call(window,k("admin.forbidden"),"error"),M.push("/"))}}function E(e){var o;const t={page:e,per_page:25};return(o=n.search)!=null&&o.trim()&&(t.search=n.search.trim()),n.only_admin&&(t.only_admin=1),n.only_banned&&(t.only_banned=1),n.date_from&&(t.date_from=n.date_from),n.date_to&&(t.date_to=n.date_to),t}async function f(e=1){b.value=!0;try{const{data:t}=await i.users(E(e));B.value={items:t.items??[],meta:t.meta??{}},h.value=e}finally{b.value=!1}}async function I(e=1){b.value=!0;try{const{data:t}=await i.auditLog({page:e,per_page:30});C.value={items:t.items??[],meta:t.meta??{}},U.value=e}finally{b.value=!1}}async function N(e){var t,o,a;try{await i.updateUser(e.id,{is_admin:!e.is_admin}),await f(h.value),await m()}catch(l){(a=window._dartToast)==null||a.call(window,((o=(t=l.response)==null?void 0:t.data)==null?void 0:o.message)||"Error","error")}}function V(e){s.kind="ban",s.user=e,s.banReason=e.ban_reason||"",s.revokeAck=!1,s.open=!0}function L(e){s.kind="unban",s.user=e,s.banReason="",s.revokeAck=!1,s.open=!0}function O(e){s.kind="revoke",s.user=e,s.banReason="",s.revokeAck=!1,s.open=!0}function D(){s.open=!1,s.user=null,s.kind="",s.banReason="",s.revokeAck=!1,y.value=!1}async function J(){var t,o,a,l;const e=s.user;if(!(!e||y.value)&&!(s.kind==="revoke"&&!s.revokeAck)){y.value=!0;try{if(s.kind==="ban")await i.updateUser(e.id,{is_banned:!0,ban_reason:s.banReason.trim()||null});else if(s.kind==="unban")await i.updateUser(e.id,{is_banned:!1});else if(s.kind==="revoke"){const{data:r}=await i.revokeSessions(e.id);(t=window._dartToast)==null||t.call(window,"OK: "+(r.deleted??0),"success")}D(),await f(h.value),await m()}catch(r){(l=window._dartToast)==null||l.call(window,((a=(o=r.response)==null?void 0:o.data)==null?void 0:a.message)||"Error","error")}finally{y.value=!1}}}async function q(e){var t,o,a;try{const{data:l}=await i.inspectMatch(e);x.value="Match #"+e,u.value=l}catch(l){(a=window._dartToast)==null||a.call(window,((o=(t=l.response)==null?void 0:t.data)==null?void 0:o.message)||"Error","error")}}async function H(e){var t,o,a;try{const{data:l}=await i.inspectRoom(e);x.value="Room #"+e,u.value=l}catch(l){(a=window._dartToast)==null||a.call(window,((o=(t=l.response)==null?void 0:t.data)==null?void 0:o.message)||"Error","error")}}function W(e,t){d.kind=e,d.id=t,d.chk=!1,d.open=!0}async function G(){var e,t,o,a;if(d.chk)try{d.kind==="match_abandon"?await i.forceAbandonMatch(d.id,{confirm:!0}):d.kind==="room_close"&&await i.forceCloseRoom(d.id,{confirm:!0}),d.open=!1,u.value=null,x.value="",(e=window._dartToast)==null||e.call(window,"OK","success"),await m()}catch(l){(a=window._dartToast)==null||a.call(window,((o=(t=l.response)==null?void 0:t.data)==null?void 0:o.message)||"Error","error")}}function $(){u.value=null,x.value=""}function K(e){if(e==null)return"—";const t=new Date(typeof e=="number"?e*1e3:e);return isNaN(t.getTime())?"—":t.toLocaleString(g.locale==="lv"?"lv-LV":"en-GB")}function X(e){if(!e)return"—";const t=new Date(e);return isNaN(t.getTime())?"—":t.toLocaleString(g.locale==="lv"?"lv-LV":"en-GB")}return S(()=>p.hydrated,async e=>{var t;if(e){if(!((t=p.user)!=null&&t.is_admin)){M.replace("/");return}await Promise.all([m(),f(1),I(1)])}},{immediate:!0}),S(()=>[n.search,n.only_admin,n.only_banned,n.date_from,n.date_to],()=>{var e;!p.hydrated||!((e=p.user)!=null&&e.is_admin)||(clearTimeout(w),w=setTimeout(()=>{f(1)},400))}),tt(()=>{clearTimeout(w)}),{auth:p,t:k,locale:g,tab:P,loading:b,overview:A,users:B,userPage:h,userFilters:n,audit:C,auditPage:U,inspectJson:u,inspectTitle:x,danger:d,userModal:s,userModalBusy:y,loadOverview:m,loadUsers:f,loadAudit:I,toggleAdmin:N,openBanModal:V,openUnbanModal:L,openRevokeModal:O,closeUserModal:D,submitUserModal:J,copyText:F,fmtTs:K,fmtIso:X,openInspectMatch:q,openInspectRoom:H,openDanger:W,execDanger:G,closeInspect:$,ipCountryByIp:_,flagEmoji:j}},template:`
