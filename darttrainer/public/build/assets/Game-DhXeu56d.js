import{o as pe,a2 as ct,r as _,z as i,u as mt,a as ut,c as pt,w as bt,e as xt,I as ft}from"./main-BeFAckYu.js";import{u as gt}from"./useBodyShellClass-DX4-pM2O.js";import{useGameStore as vt}from"./game-sa4gb2i-.js";/* empty css            */import"./index-BuNY4Ty6.js";const ht={props:{matchId:{type:[String,Number],required:!0}},emits:["home"],setup(A,{emit:m}){const C=_(!0),z=_(null),N=_(null),M=i(()=>{var c,B;return((B=(c=N.value)==null?void 0:c.match)==null?void 0:B.game_type)==="cricket"}),p=i(()=>{var c,B;return((B=(c=N.value)==null?void 0:c.match)==null?void 0:B.game_type)==="x01"}),S=i(()=>{var c;return((c=N.value)==null?void 0:c.report)??null}),v=i(()=>{var c;return((c=S.value)==null?void 0:c.meta)??{}}),y=i(()=>{var c;return((c=S.value)==null?void 0:c.player_rows)??[]}),V=i(()=>{var c;return((c=S.value)==null?void 0:c.agp)??null}),L=i(()=>{var c;return((c=S.value)==null?void 0:c.leg_rows)??[]});function E(c){if(!c)return"—";try{return new Date(c).toLocaleString("lv-LV",{weekday:"short",day:"numeric",month:"short",year:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return c}}function W(){window.print()}return pe(async()=>{C.value=!0,z.value=null;try{const{data:c}=await ct.protocol(A.matchId);N.value=c}catch{z.value="Neizdevās ielādēt protokolu."}finally{C.value=!1}}),{loading:C,error:z,payload:N,isCricket:M,isX01:p,report:S,meta:v,rows:y,agp:V,legRows:L,fmtDateTime:E,printReport:W,goHome:()=>m("home")}},template:`
