import{o as pe,V as ct,m as _,l as i,u as mt,a as ut,b as pt,w as bt,E as xt,A as ft}from"./main-uXla6Gc2.js";import{u as gt}from"./useBodyShellClass-WgJGgH1O.js";import{useGameStore as vt}from"./game-ByJVqBq0.js";/* empty css            */import"./index-BuNY4Ty6.js";const ht={props:{matchId:{type:[String,Number],required:!0}},emits:["home"],setup(A,{emit:m}){const C=_(!0),F=_(null),N=_(null),R=i(()=>{var d,M;return((M=(d=N.value)==null?void 0:d.match)==null?void 0:M.game_type)==="cricket"}),u=i(()=>{var d,M;return((M=(d=N.value)==null?void 0:d.match)==null?void 0:M.game_type)==="x01"}),S=i(()=>{var d;return((d=N.value)==null?void 0:d.report)??null}),v=i(()=>{var d;return((d=S.value)==null?void 0:d.meta)??{}}),y=i(()=>{var d;return((d=S.value)==null?void 0:d.player_rows)??[]}),K=i(()=>{var d;return((d=S.value)==null?void 0:d.agp)??null}),L=i(()=>{var d;return((d=S.value)==null?void 0:d.leg_rows)??[]});function E(d){if(!d)return"—";try{return new Date(d).toLocaleString("lv-LV",{weekday:"short",day:"numeric",month:"short",year:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return d}}function W(){window.print()}return pe(async()=>{C.value=!0,F.value=null;try{const{data:d}=await ct.protocol(A.matchId);N.value=d}catch{F.value="Neizdevās ielādēt protokolu."}finally{C.value=!1}}),{loading:C,error:F,payload:N,isCricket:R,isX01:u,report:S,meta:v,rows:y,agp:K,legRows:L,fmtDateTime:E,printReport:W,goHome:()=>m("home")}},template:`
