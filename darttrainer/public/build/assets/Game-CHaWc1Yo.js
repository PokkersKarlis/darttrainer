import{o as Ct,e as Ot,r as q,a2 as Fe,z as f,f as r,g as i,h as e,t as m,F as P,x as D,n as A,y as j,l as $,j as Y,i as tt,p as O,a as Xt,u as Ee,c as Ge,w as Ue,K as We,I as Ve}from"./main-eX0Cbe8_.js";import{u as qe}from"./useBodyShellClass-oCSLdIuB.js";import{useGameStore as Ke}from"./game-C1aAPljs.js";/* empty css            */import"./index-BuNY4Ty6.js";const Oe=.92,Vt=1.08;function Xe(){if(typeof window>"u")return{w:1,h:1};const t=window.visualViewport,g=t?Math.max(1,Math.round(t.width)):Math.max(1,window.innerWidth),w=t?Math.max(1,Math.round(t.height)):Math.max(1,window.innerHeight);return{w:g,h:w}}function _e(t,g){const w=t/g;return w>=Oe&&w<=Vt?t>=800?{kind:"landscape",label:"Landscape"}:{kind:"square",label:"Square"}:w>Vt?{kind:"landscape",label:"Landscape"}:{kind:"portrait",label:"Portrait"}}function Je(){const t=q("portrait"),g=q("Portrait"),w=q(0),y=q(0),c=q("1.000");function k(){const{w:n,h:x}=Xe(),{kind:h,label:N}=_e(n,x);w.value=n,y.value=x,c.value=(n/x).toFixed(3),t.value=h,g.value=N}function b(){requestAnimationFrame(()=>k())}return Ct(()=>{k(),window.addEventListener("resize",k,{passive:!0}),window.addEventListener("orientationchange",b);const n=window.visualViewport;n&&n.addEventListener("resize",k,{passive:!0})}),Ot(()=>{window.removeEventListener("resize",k),window.removeEventListener("orientationchange",b);const n=typeof window<"u"?window.visualViewport:null;n&&n.removeEventListener("resize",k)}),{layoutKind:t,layoutLabel:g,layoutWidth:w,layoutHeight:y,layoutAspect:c,syncGameScreenLayout:k}}const Qe={props:{matchId:{type:[String,Number],required:!0}},emits:["home"],setup(t,{emit:g}){const w=q(!0),y=q(null),c=q(null),k=f(()=>{var S,W;return((W=(S=c.value)==null?void 0:S.match)==null?void 0:W.game_type)==="cricket"}),b=f(()=>{var S,W;return((W=(S=c.value)==null?void 0:S.match)==null?void 0:W.game_type)==="x01"}),n=f(()=>{var S;return((S=c.value)==null?void 0:S.report)??null}),x=f(()=>{var S;return((S=n.value)==null?void 0:S.meta)??{}}),h=f(()=>{var S;return((S=n.value)==null?void 0:S.player_rows)??[]}),N=f(()=>{var S;return((S=n.value)==null?void 0:S.agp)??null}),o=f(()=>{var S;return((S=n.value)==null?void 0:S.leg_rows)??[]});function v(S){if(!S)return"—";try{return new Date(S).toLocaleString("lv-LV",{weekday:"short",day:"numeric",month:"short",year:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return S}}function U(){window.print()}return Ct(async()=>{w.value=!0,y.value=null;try{const{data:S}=await Fe.protocol(t.matchId);c.value=S}catch{y.value="Neizdevās ielādēt protokolu."}finally{w.value=!1}}),{loading:w,error:y,payload:c,isCricket:k,isX01:b,report:n,meta:x,rows:h,agp:N,legRows:o,fmtDateTime:v,printReport:U,goHome:()=>g("home")}},template:`
