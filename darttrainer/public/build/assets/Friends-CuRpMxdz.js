import{u as _,a as H,Q as C,o as O,I as x,q as t}from"./main-ClvtaMgc.js";/* empty css            */import"./index-BuNY4Ty6.js";const P={setup(){const w=_(),S=H(),a=C(),n=e=>S.t(e),k=t(""),d=t([]),b=t(!1),p=t([]),c=t(!0),M=t("list");async function i(){if(!w.user){c.value=!1;return}c.value=!0;try{const{data:e}=await x.list();p.value=e.items||[],await a.refresh()}catch{p.value=[]}finally{c.value=!1}}O(i);let m=null;function R(){m&&clearTimeout(m),m=setTimeout(u,280)}async function u(){const e=k.value.trim();if(e.length<1){d.value=[];return}b.value=!0;try{const{data:s}=await x.search(e);d.value=s.items||[]}catch{d.value=[]}finally{b.value=!1}}async function j(e){var s,r,l,o;try{await x.sendRequest(e),(s=window._dartToast)==null||s.call(window,n("friends.requestSent"),"success"),await u(),a.refresh()}catch(h){const y=((l=(r=h.response)==null?void 0:r.data)==null?void 0:l.error)||n("common.error");(o=window._dartToast)==null||o.call(window,y,"error")}}async function I(e){await a.acceptRequest(e),await i()}async function L(e){await a.rejectRequest(e),await i()}const v=t(null),g=t(!1),f=t(null);function q(e){f.value={id:e.id,name:e.name||""},g.value=!0}function T(){g.value=!1,f.value=null}async function F(){var s,r,l,o;const e=f.value;if(e){v.value=e.id;try{await x.remove(e.id),(s=window._dartToast)==null||s.call(window,n("friends.removedToast"),"success"),T(),await i(),await u()}catch(h){const y=((l=(r=h.response)==null?void 0:r.data)==null?void 0:l.error)||n("common.error");(o=window._dartToast)==null||o.call(window,y,"error")}finally{v.value=null}}}return{auth:w,t:n,tab:M,searchQ:k,searchHits:d,searching:b,onSearchInput:R,runSearch:u,sendRequest:j,friendList:p,loading:c,friendsStore:a,accept:I,reject:L,loadLists:i,openRemoveModal:q,closeRemoveModal:T,confirmRemoveFriend:F,removeModalOpen:g,removeTarget:f,removingId:v}},template:`
