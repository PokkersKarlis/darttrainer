import{u as K,a as X,b as q,w as D,G as Q,V as i,B as k,q as r}from"./main-DxvYso1Y.js";/* empty css            */import"./index-BuNY4Ty6.js";const $={setup(){const p=K(),y=X(),g=t=>y.t(t),_=q(),R=r("users"),x=r(!1),T=r(null),M=r({items:[],meta:{}}),h=r(1),d=k({search:"",only_admin:!1,only_banned:!1,date_from:"",date_to:""}),A=r({items:[],meta:{}}),U=r(1),b=r(null),u=r(""),n=k({open:!1,kind:"",id:null,chk:!1}),a=k({open:!1,kind:"",user:null,banReason:"",revokeAck:!1}),m=r(!1);let w=null;function I(t,e){var l,o;const s=String(e??"");(l=navigator.clipboard)!=null&&l.writeText?navigator.clipboard.writeText(s).then(()=>{var c;(c=window._dartToast)==null||c.call(window,g("admin.copied")+": "+t,"success")}).catch(()=>{var c;return(c=window._dartToast)==null?void 0:c.call(window,"Copy failed","error")}):(o=window._dartToast)==null||o.call(window,"Clipboard nav pieejams","error")}async function v(){var t,e;try{const{data:s}=await i.overview();T.value=s}catch(s){((t=s.response)==null?void 0:t.status)===403&&((e=window._dartToast)==null||e.call(window,g("admin.forbidden"),"error"),_.push("/"))}}function S(t){var s;const e={page:t,per_page:25};return(s=d.search)!=null&&s.trim()&&(e.search=d.search.trim()),d.only_admin&&(e.only_admin=1),d.only_banned&&(e.only_banned=1),d.date_from&&(e.date_from=d.date_from),d.date_to&&(e.date_to=d.date_to),e}async function f(t=1){x.value=!0;try{const{data:e}=await i.users(S(t));M.value={items:e.items??[],meta:e.meta??{}},h.value=t}finally{x.value=!1}}async function B(t=1){x.value=!0;try{const{data:e}=await i.auditLog({page:t,per_page:30});A.value={items:e.items??[],meta:e.meta??{}},U.value=t}finally{x.value=!1}}async function F(t){var e,s,l;try{await i.updateUser(t.id,{is_admin:!t.is_admin}),await f(h.value),await v()}catch(o){(l=window._dartToast)==null||l.call(window,((s=(e=o.response)==null?void 0:e.data)==null?void 0:s.message)||"Error","error")}}function N(t){a.kind="ban",a.user=t,a.banReason=t.ban_reason||"",a.revokeAck=!1,a.open=!0}function j(t){a.kind="unban",a.user=t,a.banReason="",a.revokeAck=!1,a.open=!0}function C(t){a.kind="revoke",a.user=t,a.banReason="",a.revokeAck=!1,a.open=!0}function P(){a.open=!1,a.user=null,a.kind="",a.banReason="",a.revokeAck=!1,m.value=!1}async function O(){var e,s,l,o;const t=a.user;if(!(!t||m.value)&&!(a.kind==="revoke"&&!a.revokeAck)){m.value=!0;try{if(a.kind==="ban")await i.updateUser(t.id,{is_banned:!0,ban_reason:a.banReason.trim()||null});else if(a.kind==="unban")await i.updateUser(t.id,{is_banned:!1});else if(a.kind==="revoke"){const{data:c}=await i.revokeSessions(t.id);(e=window._dartToast)==null||e.call(window,"OK: "+(c.deleted??0),"success")}P(),await f(h.value),await v()}catch(c){(o=window._dartToast)==null||o.call(window,((l=(s=c.response)==null?void 0:s.data)==null?void 0:l.message)||"Error","error")}finally{m.value=!1}}}async function E(t){var e,s,l;try{const{data:o}=await i.inspectMatch(t);u.value="Match #"+t,b.value=o}catch(o){(l=window._dartToast)==null||l.call(window,((s=(e=o.response)==null?void 0:e.data)==null?void 0:s.message)||"Error","error")}}async function J(t){var e,s,l;try{const{data:o}=await i.inspectRoom(t);u.value="Room #"+t,b.value=o}catch(o){(l=window._dartToast)==null||l.call(window,((s=(e=o.response)==null?void 0:e.data)==null?void 0:s.message)||"Error","error")}}function L(t,e){n.kind=t,n.id=e,n.chk=!1,n.open=!0}async function V(){var t,e,s,l;if(n.chk)try{n.kind==="match_abandon"?await i.forceAbandonMatch(n.id,{confirm:!0}):n.kind==="room_close"&&await i.forceCloseRoom(n.id,{confirm:!0}),n.open=!1,b.value=null,u.value="",(t=window._dartToast)==null||t.call(window,"OK","success"),await v()}catch(o){(l=window._dartToast)==null||l.call(window,((s=(e=o.response)==null?void 0:e.data)==null?void 0:s.message)||"Error","error")}}function z(){b.value=null,u.value=""}function G(t){if(t==null)return"—";const e=new Date(typeof t=="number"?t*1e3:t);return isNaN(e.getTime())?"—":e.toLocaleString(y.locale==="lv"?"lv-LV":"en-GB")}function H(t){if(!t)return"—";const e=new Date(t);return isNaN(e.getTime())?"—":e.toLocaleString(y.locale==="lv"?"lv-LV":"en-GB")}return D(()=>p.hydrated,async t=>{var e;if(t){if(!((e=p.user)!=null&&e.is_admin)){_.replace("/");return}await Promise.all([v(),f(1),B(1)])}},{immediate:!0}),D(()=>[d.search,d.only_admin,d.only_banned,d.date_from,d.date_to],()=>{var t;!p.hydrated||!((t=p.user)!=null&&t.is_admin)||(clearTimeout(w),w=setTimeout(()=>{f(1)},400))}),Q(()=>{clearTimeout(w)}),{auth:p,t:g,locale:y,tab:R,loading:x,overview:T,users:M,userPage:h,userFilters:d,audit:A,auditPage:U,inspectJson:b,inspectTitle:u,danger:n,userModal:a,userModalBusy:m,loadOverview:v,loadUsers:f,loadAudit:B,toggleAdmin:F,openBanModal:N,openUnbanModal:j,openRevokeModal:C,closeUserModal:P,submitUserModal:O,copyText:I,fmtTs:G,fmtIso:H,openInspectMatch:E,openInspectRoom:J,openDanger:L,execDanger:V,closeInspect:z}},template:`
