import{u as K,a as X,c as Q,w as P,e as q,a1 as d,I as w,r as i}from"./main-BeFAckYu.js";/* empty css            */import"./index-BuNY4Ty6.js";const $={setup(){const p=K(),v=X(),k=e=>v.t(e),_=Q(),R=i("users"),b=i(!1),M=i(null),T=i({items:[],meta:{}}),g=i(1),r=w({search:"",only_admin:!1,only_banned:!1,date_from:"",date_to:""}),A=i({items:[],meta:{}}),U=i(1),u=i(null),x=i(""),n=w({open:!1,kind:"",id:null,chk:!1}),o=w({open:!1,kind:"",user:null,banReason:"",revokeAck:!1}),m=i(!1);let h=null;function D(e,t){var s,l;const a=String(t??"");(s=navigator.clipboard)!=null&&s.writeText?navigator.clipboard.writeText(a).then(()=>{var c;(c=window._dartToast)==null||c.call(window,k("admin.copied")+": "+e,"success")}).catch(()=>{var c;return(c=window._dartToast)==null?void 0:c.call(window,"Copy failed","error")}):(l=window._dartToast)==null||l.call(window,"Clipboard nav pieejams","error")}async function y(){var e,t;try{const{data:a}=await d.overview();M.value=a}catch(a){((e=a.response)==null?void 0:e.status)===403&&((t=window._dartToast)==null||t.call(window,k("admin.forbidden"),"error"),_.push("/"))}}function I(e){var a;const t={page:e,per_page:25};return(a=r.search)!=null&&a.trim()&&(t.search=r.search.trim()),r.only_admin&&(t.only_admin=1),r.only_banned&&(t.only_banned=1),r.date_from&&(t.date_from=r.date_from),r.date_to&&(t.date_to=r.date_to),t}async function f(e=1){b.value=!0;try{const{data:t}=await d.users(I(e));T.value={items:t.items??[],meta:t.meta??{}},g.value=e}finally{b.value=!1}}async function B(e=1){b.value=!0;try{const{data:t}=await d.auditLog({page:e,per_page:30});A.value={items:t.items??[],meta:t.meta??{}},U.value=e}finally{b.value=!1}}async function S(e){var t,a,s;try{await d.updateUser(e.id,{is_admin:!e.is_admin}),await f(g.value),await y()}catch(l){(s=window._dartToast)==null||s.call(window,((a=(t=l.response)==null?void 0:t.data)==null?void 0:a.message)||"Error","error")}}function j(e){o.kind="ban",o.user=e,o.banReason=e.ban_reason||"",o.revokeAck=!1,o.open=!0}function z(e){o.kind="unban",o.user=e,o.banReason="",o.revokeAck=!1,o.open=!0}function F(e){o.kind="revoke",o.user=e,o.banReason="",o.revokeAck=!1,o.open=!0}function C(){o.open=!1,o.user=null,o.kind="",o.banReason="",o.revokeAck=!1,m.value=!1}async function N(){var t,a,s,l;const e=o.user;if(!(!e||m.value)&&!(o.kind==="revoke"&&!o.revokeAck)){m.value=!0;try{if(o.kind==="ban")await d.updateUser(e.id,{is_banned:!0,ban_reason:o.banReason.trim()||null});else if(o.kind==="unban")await d.updateUser(e.id,{is_banned:!1});else if(o.kind==="revoke"){const{data:c}=await d.revokeSessions(e.id);(t=window._dartToast)==null||t.call(window,"OK: "+(c.deleted??0),"success")}C(),await f(g.value),await y()}catch(c){(l=window._dartToast)==null||l.call(window,((s=(a=c.response)==null?void 0:a.data)==null?void 0:s.message)||"Error","error")}finally{m.value=!1}}}async function L(e){var t,a,s;try{const{data:l}=await d.inspectMatch(e);x.value="Match #"+e,u.value=l}catch(l){(s=window._dartToast)==null||s.call(window,((a=(t=l.response)==null?void 0:t.data)==null?void 0:a.message)||"Error","error")}}async function O(e){var t,a,s;try{const{data:l}=await d.inspectRoom(e);x.value="Room #"+e,u.value=l}catch(l){(s=window._dartToast)==null||s.call(window,((a=(t=l.response)==null?void 0:t.data)==null?void 0:a.message)||"Error","error")}}function E(e,t){n.kind=e,n.id=t,n.chk=!1,n.open=!0}async function J(){var e,t,a,s;if(n.chk)try{n.kind==="match_abandon"?await d.forceAbandonMatch(n.id,{confirm:!0}):n.kind==="room_close"&&await d.forceCloseRoom(n.id,{confirm:!0}),n.open=!1,u.value=null,x.value="",(e=window._dartToast)==null||e.call(window,"OK","success"),await y()}catch(l){(s=window._dartToast)==null||s.call(window,((a=(t=l.response)==null?void 0:t.data)==null?void 0:a.message)||"Error","error")}}function H(){u.value=null,x.value=""}function V(e){if(e==null)return"—";const t=new Date(typeof e=="number"?e*1e3:e);return isNaN(t.getTime())?"—":t.toLocaleString(v.locale==="lv"?"lv-LV":"en-GB")}function G(e){if(!e)return"—";const t=new Date(e);return isNaN(t.getTime())?"—":t.toLocaleString(v.locale==="lv"?"lv-LV":"en-GB")}return P(()=>p.hydrated,async e=>{var t;if(e){if(!((t=p.user)!=null&&t.is_admin)){_.replace("/");return}await Promise.all([y(),f(1),B(1)])}},{immediate:!0}),P(()=>[r.search,r.only_admin,r.only_banned,r.date_from,r.date_to],()=>{var e;!p.hydrated||!((e=p.user)!=null&&e.is_admin)||(clearTimeout(h),h=setTimeout(()=>{f(1)},400))}),q(()=>{clearTimeout(h)}),{auth:p,t:k,locale:v,tab:R,loading:b,overview:M,users:T,userPage:g,userFilters:r,audit:A,auditPage:U,inspectJson:u,inspectTitle:x,danger:n,userModal:o,userModalBusy:m,loadOverview:y,loadUsers:f,loadAudit:B,toggleAdmin:S,openBanModal:j,openUnbanModal:z,openRevokeModal:F,closeUserModal:C,submitUserModal:N,copyText:D,fmtTs:V,fmtIso:G,openInspectMatch:L,openInspectRoom:O,openDanger:E,execDanger:J,closeInspect:H}},template:`
