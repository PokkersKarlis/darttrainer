import{a as B,l as b,E as z,b as A,u as F,w as H,o as U,O as u,m as i,z as j}from"./main-5gy0Lqdt.js";/* empty css            */import"./index-BuNY4Ty6.js";const K={props:{state:{type:Object,required:!0},defaultOpen:{type:Boolean,default:!1}},setup(d){const y=B(),n=e=>y.t(e);function c(e){const r=e.seg??e.segment,o=e.mul??e.multiplier;return r===0?n("x01Training.dartMiss"):r===25&&o===2?n("x01Training.dartBull"):r===25?n("x01Training.dartOuter"):(o===2?"D":o===3?"T":"")+r}function h(e){const r=e.mul??e.multiplier;return(e.seg??e.segment)===0?"text-slate-600":r===3?"text-emerald-400":r===2?"text-sky-400":"text-slate-300"}const l=b(()=>[{key:"1-1",label:n("x01Training.protocolSingleMatch"),turns:d.state.turns||[]}]);function x(e){return e.bust?n("x01Training.protocolBust"):e.checkout?n("x01Training.protocolCheckout"):d.state.in_mode==="double"&&!e.opened?n("x01Training.protocolWaitDoubleIn"):"—"}return{t:n,dartLabel:c,dartClass:h,legs:l,turnNotes:x}},template:`
  ...
  `},Z={components:{X01SoloProtocol:K},setup(){const d=z(),y=A(),n=B(),c=F(),h=t=>n.t(t),l=i(null),x=i(!1),e=i(!1),r=i(!0),o=i(1),p=j({variant:501,in_mode:"straight",out_mode:"double"}),s=j({darts:[]}),m=i(null),v=i(null),f=i(!1),g=i(!1),k=b(()=>{const t=d.query.protocol;return t!=null&&String(t).trim()!==""});async function w(){if(!k.value){v.value=null,g.value=!1,f.value=!1;return}const t=Number(d.query.protocol);if(!Number.isFinite(t)||t<1){g.value=!0,f.value=!1;return}f.value=!0,g.value=!1,v.value=null;try{const{data:a}=await u.x01Protocol(t);v.value=a.state}catch{g.value=!0}finally{f.value=!1}}function E(){y.replace({path:"/training/x01"})}H(()=>d.query.protocol,w),U(async()=>{if(await w(),!v.value)try{const{data:t}=await u.x01State();t.state&&(l.value=t.state,r.value=!1)}catch{}});async function D(){var t;if(c.needsEmailVerification){(t=window._dartToast)==null||t.call(window,h("auth.verifyEmailToContinue"),"error");return}x.value=!0;try{const{data:a}=await u.x01Start({variant:p.variant,in_mode:p.in_mode,out_mode:p.out_mode});l.value=a.state,r.value=!1,s.darts=[],o.value=1}finally{x.value=!1}}async function C(){c.needsEmailVerification||(await u.x01Abandon(),l.value=null,r.value=!0,s.darts=[],m.value=null,o.value=1)}function O(t){if(s.darts.length>=3)return;let a=o.value;t===25&&a===3&&(a=1),s.darts.push({segment:t,multiplier:a})}function V(){s.darts.length>=3||s.darts.push({segment:0,multiplier:0})}function M(){s.darts.length>=3||s.darts.push({segment:25,multiplier:1})}function P(){s.darts.length>=3||s.darts.push({segment:25,multiplier:2})}function R(t){s.darts.splice(t,1)}function L(t){return t.segment===0?"Miss":t.segment===25&&t.multiplier===2?"Bull":t.segment===25?"Outer":(t.multiplier===2?"D":t.multiplier===3?"T":"")+t.segment}function T(t){return t.segment===0?0:t.segment*t.multiplier}function G(t){return t.segment===0?"text-slate-600":t.multiplier===3?"text-emerald-400":t.multiplier===2?"text-sky-400":"text-white"}async function N(){if(c.needsEmailVerification||s.darts.length===0||e.value)return;e.value=!0;const t=s.darts.map(a=>({segment:a.segment,multiplier:a.multiplier}));try{const{data:a}=await u.x01Throw({darts:t});l.value=a.state,m.value=a.result,s.darts=[],o.value=1,setTimeout(()=>{m.value=null},2200)}finally{e.value=!1}}async function Q(){if(c.needsEmailVerification)return;const{data:t}=await u.x01Undo();l.value=t.state,s.darts=[],m.value=null}const S=b(()=>s.darts.reduce((t,a)=>t+T(a),0)),_=b(()=>l.value?l.value.current_score-S.value:null),X=b(()=>{var a,I;if(((a=l.value)==null?void 0:a.in_mode)==="double"&&!((I=l.value)!=null&&I.opened))return!1;const t=_.value;return t===null?!1:t<0||t===1}),q=b(()=>o.value===2?"text-sky-300":o.value===3?"text-emerald-300":"text-white");return{route:d,auth:c,t:h,state:l,loading:x,submitting:e,showSetup:r,form:p,activeMultiplier:o,dartInput:s,feedback:m,turnTotal:S,projectedRemaining:_,projectedBust:X,mulTint:q,startGame:D,abandon:C,addSegment:O,addMiss:V,addOuter:M,addBull:P,removeDart:R,dartLabel:L,dartValue:T,dartColor:G,submitThrow:N,undo:Q,showProtocolQuery:k,protocolOnlyState:v,protocolLoading:f,protocolError:g,clearProtocolQuery:E}},template:`
